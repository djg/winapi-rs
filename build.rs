...
const DATA: &'static [(&'static str, &'static [&'static str], &'static [&'static str])] = &[
    ...
    ("mfapi", &["basetsd", "dxgiformat", "guiddef", "mfobjects", "minwindef", "mmreg", "propidl", "unknwnbase", "windef", "wingdi", "winnt"], &["mfplat"]),
    ("mfidl", &["basetsd", "guiddef", "mfobjects", "mftransform", "minwindef", "objidlbase", "propidl", "propsys", "unknwnbase", "windef", "winnt", "wtypes"], &[]),
    ("mfobjects", &["basetsd", "guiddef", "minwindef", "mmreg", "objidlbase", "propidl", "unknwnbase", "windef", "winnt", "wtypes"], &["mfuuid"]),
    ("mfreadwrite", &["guiddef", "mfidl", "mfobjects", "mftransform", "minwindef", "propidl", "unknwnbase", "winnt"], &["mfreadwrite"]),
    ("mftransform", &["basetsd", "guiddef", "mfobjects", "minwindef", "unknwnbase", "winnt", "wtypes"], &[]),
