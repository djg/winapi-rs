...
fn um_mfidl() {
    ...
    assert_eq!(size_of::<MFRR_COMPONENTS>(), 12);
    assert_eq!(align_of::<MFRR_COMPONENTS>(), 4);
    ...
    assert_eq!(size_of::<MFBYTESTREAM_BUFFERING_PARAMS>(), 56);
    ...
    assert_eq!(size_of::<MFNetCredentialManagerGetParam>(), 32);
    assert_eq!(align_of::<MFNetCredentialManagerGetParam>(), 4);
    assert_eq!(size_of::<MFINPUTTRUSTAUTHORITY_ACCESS_ACTION>(), 12);
    assert_eq!(align_of::<MFINPUTTRUSTAUTHORITY_ACCESS_ACTION>(), 4);
    assert_eq!(size_of::<MFINPUTTRUSTAUTHORITY_ACCESS_PARAMS>(), 40);
    assert_eq!(align_of::<MFINPUTTRUSTAUTHORITY_ACCESS_PARAMS>(), 4);
    assert_eq!(size_of::<MF_TRANSCODE_SINK_INFO>(), 16);
    assert_eq!(align_of::<MF_TRANSCODE_SINK_INFO>(), 4);
    assert_eq!(size_of::<MFT_REGISTRATION_INFO>(), 56);
    assert_eq!(align_of::<MFT_REGISTRATION_INFO>(), 4);
    ...
    assert_eq!(size_of::<MFMediaKeyStatus>(), 12);
    assert_eq!(align_of::<MFMediaKeyStatus>(), 4);
...
fn um_mftranform() {
    ...
    assert_eq!(size_of::<MFT_OUTPUT_DATA_BUFFER>(), 16);
    assert_eq!(align_of::<MFT_OUTPUT_DATA_BUFFER>(), 4);
