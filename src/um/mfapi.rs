use ctypes::{c_char, c_float, c_int, c_void};
use shared::basetsd::{INT16, INT32, UINT32, UINT64, UINT8};
#[cfg(feature = "dxgiformat")]
use shared::dxgiformat::DXGI_FORMAT;
use shared::guiddef::{CLSID, GUID, REFCLSID, REFGUID, REFIID};
use shared::minwindef::{
    BOOL, BYTE, DWORD, FLOAT, LPDWORD, LPVOID, UINT, ULONG, WORD
};
use shared::mmreg::WAVEFORMATEX;
use shared::windef::{POINT, RECT};
use um::mfobjects::{
    IMFActivate, IMFAsyncCallback, IMFAsyncResult, IMFAttributes,
    IMFAudioMediaType, IMFByteStream, IMFCollection, IMFDXGIDeviceManager,
    IMFMediaBuffer, IMFMediaEvent, IMFMediaEventQueue, IMFMediaType,
    IMFPluginControl, IMFSample, IMFVideoMediaType, MFStandardVideoFormat,
    MFT_REGISTER_TYPE_INFO, MFVIDEOFORMAT, MFVideoInterlaceMode,
    MF_FILE_ACCESSMODE, MF_FILE_FLAGS, MF_FILE_OPENMODE, MediaEventType, QWORD
};
...
pub const MF_SDK_VERSION: DWORD = 2;
pub const MF_API_VERSION: DWORD = 0x70;
pub const MF_VERSION: DWORD = MF_SDK_VERSION << 16 | MF_API_VERSION;
pub const MFSTARTUP_NOSOCKET: DWORD = 1;
...
extern "system" {
    ...
    pub fn MFGetTimerPeriodicity(
        Periodicity: *mut DWORD,
    ) -> HRESULT;
}
pub type MFPERIODICCALLBACK = unsafe extern fn(*mut IUnknown) -> ();
extern "system" {
...
extern "system" {
    ...
    pub fn MFUnregisterPlatformFromMMCSS() -> HRESULT;
...
extern "system" {
    ...
    pub fn MFCreateEventQueue(
        ppMediaEventQueue: *mut *mut IMFMediaEventQueue,
    ) -> HRESULT;
}
...
pub const MFSESSIONCAP_START: DWORD = 0x00000001;
pub const MFSESSIONCAP_SEEK: DWORD = 0x00000002;
pub const MFSESSIONCAP_PAUSE: DWORD = 0x00000004;
pub const MFSESSIONCAP_RATE_FORWARD: DWORD = 0x00000010;
pub const MFSESSIONCAP_RATE_REVERSE: DWORD = 0x00000020;
pub const MFSESSIONCAP_DOES_NOT_USE_NETWORK: DWORD = 0x00000040;
...
DEFINE_GUID!{MF_EVENT_START_PRESENTATION_TIME,
    0x5ad914d0, 0x9b45, 0x4a8d, 0xa2, 0xc0, 0x81, 0xd1, 0xe5, 0x0b, 0xfb, 0x07}
DEFINE_GUID!{MF_EVENT_PRESENTATION_TIME_OFFSET,
    0x5ad914d1, 0x9b45, 0x4a8d, 0xa2, 0xc0, 0x81, 0xd1, 0xe5, 0x0b, 0xfb, 0x07}
DEFINE_GUID!{MF_EVENT_START_PRESENTATION_TIME_AT_OUTPUT,
    0x5ad914d2, 0x9b45, 0x4a8d, 0xa2, 0xc0, 0x81, 0xd1, 0xe5, 0x0b, 0xfb, 0x07}
...
DEFINE_GUID!{MF_EVENT_DO_THINNING,
    0x321ea6fb, 0xdad9, 0x46e4, 0xb3, 0x1d, 0xd2, 0xea, 0xe7, 0x09, 0x0e, 0x30}
DEFINE_GUID!{MF_EVENT_SCRUBSAMPLE_TIME,
    0x9ac712b3, 0xdcb8, 0x44d5, 0x8d, 0x0c, 0x37, 0x45, 0x5a, 0x27, 0x82, 0xe3}
...
DEFINE_GUID!{MF_EVENT_STREAM_METADATA_KEYDATA,
    0xcd59a4a1, 0x4a3b, 0x4bbd, 0x86, 0x65, 0x72, 0xa4, 0x0f, 0xbe, 0xa7, 0x76}
...
DEFINE_GUID!{MFSampleExtension_AccumulatedNonRefPicPercent,
    0x79ea74df, 0xa740, 0x445b, 0xbc, 0x98, 0xc9, 0xed, 0x1f, 0x26, 0x0e, 0xee}
DEFINE_GUID!{MFSampleExtension_Encryption_ProtectionScheme,
    0xd054d096, 0x28bb, 0x45da, 0x87, 0xec, 0x74, 0xf3, 0x51, 0x87, 0x14, 0x06}
...
DEFINE_GUID!{MFSampleExtension_Encryption_CryptByteBlock,
    0x9d84289b, 0x0c7f, 0x4713, 0xab, 0x95, 0x10, 0x8a, 0xb4, 0x2a, 0xd8, 0x01}
DEFINE_GUID!{MFSampleExtension_Encryption_SkipByteBlock,
    0x0d550548, 0x8317, 0x4ab1, 0x84, 0x5f, 0xd0, 0x63, 0x06, 0xe2, 0x93, 0xe3}
...
DEFINE_GUID!{MFSampleExtension_Encryption_ClearSliceHeaderData,
    0x5509a4f4, 0x320d, 0x4e6c, 0x8d, 0x1a, 0x94, 0xc6, 0x6d, 0xd2, 0x0c, 0xb0}
...
DEFINE_GUID!{MFSampleExtension_Encryption_SPSPPSData,
    0xaede0fa2, 0x0e0c, 0x453c, 0xb7, 0xf3, 0xde, 0x86, 0x93, 0x36, 0x4d, 0x11}
...
pub const MFSampleExtension_ClosedCaption_CEA708_MAX_SIZE: DWORD = 256;
DEFINE_GUID!{MFSampleExtension_DecodeTimestamp,
    0x73a954d4, 0x09e2, 0x4861, 0xbe, 0xfc, 0x94, 0xbd, 0x97, 0xc0, 0x8e, 0x6e}
...
DEFINE_GUID!{MFSampleExtension_VideoEncodePictureType,
    0x973704e6, 0xcd14, 0x483c, 0x8f, 0x20, 0xc9, 0xfc, 0x09, 0x28, 0xba, 0xd5}
DEFINE_GUID!{MFSampleExtension_FrameCorruption,
    0xb4dd4a8c, 0x0beb, 0x44c4, 0x8b, 0x75, 0xb0, 0x2b, 0x91, 0x3b, 0x04, 0xf0}
...
DEFINE_GUID!{MFSampleExtension_HDCP_FrameCounter,
    0x9d389c60, 0xf507, 0x4aa6, 0xa4, 0x0a, 0x71, 0x02, 0x7a, 0x02, 0xf3, 0xde}
...
DEFINE_GUID!{MFSampleExtension_RepeatFrame,
    0x88be738f, 0x0711, 0x4f42, 0xb4, 0x58, 0x34, 0x4a, 0xed, 0x42, 0xec, 0x2f}
...
pub const MACROBLOCK_FLAG_SKIP: DWORD = 0x00000001;
pub const MACROBLOCK_FLAG_DIRTY: DWORD = 0x00000002;
pub const MACROBLOCK_FLAG_MOTION: DWORD = 0x00000004;
pub const MACROBLOCK_FLAG_VIDEO: DWORD = 0x00000008;
pub const MACROBLOCK_FLAG_HAS_MOTION_VECTOR: DWORD = 0x00000010;
pub const MACROBLOCK_FLAG_HAS_QP: DWORD = 0x00000020;
...
DEFINE_GUID!{MF_CAPTURE_METADATA_FLASH,
    0x4a51520b, 0xfb36, 0x446c, 0x9d, 0xf2, 0x68, 0x17, 0x1b, 0x9a, 0x03, 0x89}
DEFINE_GUID!{MF_CAPTURE_METADATA_FLASH_POWER,
    0x9c0e0d49, 0x0205, 0x491a, 0xbc, 0x9d, 0x2d, 0x6e, 0x1f, 0x4d, 0x56, 0x84}
...
DEFINE_GUID!{MF_CAPTURE_METADATA_FACEROIS,
    0x864f25a6, 0x349f, 0x46b1, 0xa3, 0x0e, 0x54, 0xcc, 0x22, 0x92, 0x8a, 0x47}
...
DEFINE_GUID!{MF_CAPTURE_METADATA_ISO_GAINS,
    0x05802ac9, 0x0e1d, 0x41c7, 0xa8, 0xc8, 0x7e, 0x73, 0x69, 0xf8, 0x4e, 0x1e}
DEFINE_GUID!{MF_CAPTURE_METADATA_SENSORFRAMERATE,
    0xdb51357e, 0x9d3d, 0x4962, 0xb0, 0x6d, 0x07, 0xce, 0x65, 0x0d, 0x9a, 0x0a}
...
DEFINE_GUID!{MF_CAPTURE_METADATA_HISTOGRAM,
    0x85358432, 0x2ef6, 0x4ba9, 0xa3, 0xfb, 0x06, 0xd8, 0x29, 0x74, 0xb8, 0x95}
...
DEFINE_GUID!{MFSampleExtension_Depth_MaxReliableDepth,
    0xe45545d1, 0x1f0f, 0x4a32, 0xa8, 0xa7, 0x61, 0x01, 0xa2, 0x4e, 0xa8, 0xbe}
...
pub const MFCAPTURE_METADATA_SCAN_RIGHT_LEFT:DWORD = 0x00000001;
pub const MFCAPTURE_METADATA_SCAN_BOTTOM_TOP:DWORD = 0x00000002;
pub const MFCAPTURE_METADATA_SCANLINE_VERTICAL:DWORD = 0x00000004;
...
pub const MF_METADATAFACIALEXPRESSION_SMILE: DWORD = 0x00000001;
...
pub const MF_METADATATIMESTAMPS_DEVICE: DWORD = 0x00000001;
pub const MF_METADATATIMESTAMPS_PRESENTATION: DWORD = 0x00000002;
...
pub const MF_HISTOGRAM_CHANNEL_Y: DWORD = 0x00000001;
pub const MF_HISTOGRAM_CHANNEL_R: DWORD = 0x00000002;
pub const MF_HISTOGRAM_CHANNEL_G: DWORD = 0x00000004;
pub const MF_HISTOGRAM_CHANNEL_B: DWORD = 0x00000008;
pub const MF_HISTOGRAM_CHANNEL_Cb: DWORD = 0x00000010;
pub const MF_HISTOGRAM_CHANNEL_Cr: DWORD = 0x00000020;
extern "system" {
...
DEFINE_GUID!{MFT_CATEGORY_VIDEO_RENDERER_EFFECT,
    0x145cd8b4, 0x92f4, 0x4b23, 0x8a, 0xe7, 0xe0, 0xdf, 0x06, 0xc2, 0xda, 0x95}
extern "system" {
    pub fn MFTRegister(
        clsidMFT: CLSID,
        guidCategory: GUID,
...
DEFINE_GUID!{VIDEO_RENDERER_EXTENSION_PROFILE,
    0x62c56928, 0x9a4e, 0x443b, 0xb9, 0xdc, 0xca, 0xc8, 0x30, 0xc2, 0x41, 0x00}
DEFINE_GUID!{ADAPTER_LUID,
...
extern "system" {
    ...
    pub fn MFGetPluginControl(
        ppPluginControl: *mut *mut IMFPluginControl,
    ) -> HRESULT;
...
DEFINE_GUID!{MFVideoFormat_Base,
    0x00000000, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_RGB32,
    0x00000016, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_ARGB32,
    0x00000015, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_RGB24,
    0x00000014, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_RGB555,
    0x00000018, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_RGB565,
    0x00000017, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_RGB8,
    0x00000029, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_L8,
    0x00000032, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_L16,
    0x00000051, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_D16,
    0x00000050, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_AI44,
    0x34344941, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_AYUV,
    0x56555941, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_YUY2,
    0x32595559, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_YVYU,
    0x55595659, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_YVU9,
    0x39555659, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_UYVY,
    0x59565955, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_NV11,
    0x3131564e, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_NV12,
    0x3231564e, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_YV12,
    0x32315659, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_I420,
    0x30323449, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_IYUV,
    0x56555949, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_Y210,
    0x30313259, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_Y216,
    0x36313259, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_Y410,
    0x30313459, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_Y416,
    0x36313459, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_Y41P,
    0x50313459, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_Y41T,
    0x54313459, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_Y42T,
    0x54323459, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_P210,
    0x30313250, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_P216,
    0x36313250, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_P010,
    0x30313050, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_P016,
    0x36313050, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_v210,
    0x30313276, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_v216,
    0x36313276, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_v410,
    0x30313476, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_MP43,
    0x3334504d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_MP4S,
    0x5334504d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_M4S2,
    0x3253344d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_MP4V,
    0x5634504d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_WMV1,
    0x31564d57, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_WMV2,
    0x32564d57, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_WMV3,
    0x33564d57, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_WVC1,
    0x31435657, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_MSS1,
    0x3153534d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_MSS2,
    0x3253534d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_MPG1,
    0x3147504d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_DVSL,
    0x6c737664, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_DVSD,
    0x64737664, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_DVHD,
    0x64687664, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_DV25,
    0x35327664, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_DV50,
    0x30357664, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_DVH1,
    0x31687664, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_DVC,
    0x20637664, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_H264,
    0x34363248, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_H265,
    0x35363248, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_MJPG,
    0x47504a4d, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_420O,
...
DEFINE_GUID!{MFVideoFormat_HEVC_ES,
    0x53564548, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_VP80,
    0x30385056, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_VP90,
    0x30395056, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_ORAW,
    0x5741524f, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_H263,
    0x33363248, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_A2R10G10B10,
    0x0000001f, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_A16B16G16R16F,
    0x00000071, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_VP10,
    0x30315056, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFVideoFormat_AV1,
...
pub const MFVideoFormat_MPG2: GUID = MFVideoFormat_MPEG2;
DEFINE_GUID!{MFAudioFormat_Base,
    0x00000000, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_PCM,
    0x00000001, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_Float,
    0x00000003, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_DTS,
    0x00000008, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_Dolby_AC3_SPDIF,
    0x00000092, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_DRM,
    0x00000009, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_WMAudioV8,
    0x00000161, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_WMAudioV9,
    0x00000162, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_WMAudio_Lossless,
    0x00000163, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_WMASPDIF,
    0x00000164, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_MSP1,
    0x0000000a, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_MP3,
    0x00000055, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_MPEG,
    0x00000050, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_AAC,
    0x00001610, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_ADTS,
    0x00001600, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_AMR_NB,
    0x00007361, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_AMR_WB,
    0x00007362, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_AMR_WP,
    0x00007363, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_FLAC,
    0x0000f1ac, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_ALAC,
    0x00006c61, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}
DEFINE_GUID!{MFAudioFormat_Opus,
...
DEFINE_GUID!{MFBinaryFormat_Base,
    0x00000000, 0xbf10, 0x48b4, 0xbc, 0x18, 0x59, 0x3d, 0xc1, 0xdb, 0x95, 0x0f}
DEFINE_GUID!{MFBinaryFormat_GPMD,
    0x646d7067, 0xbf10, 0x48b4, 0xbc, 0x18, 0x59, 0x3d, 0xc1, 0xdb, 0x95, 0x0f}
...
DEFINE_GUID!{MF_MT_VIDEO_3D_FORMAT,
    0x5315d8a0, 0x87c5, 0x4697, 0xb7, 0x93, 0x66, 0x06, 0xc6, 0x7c, 0x04, 0x9b}
...
DEFINE_GUID!{MF_MT_VIDEO_3D_FIRST_IS_LEFT,
    0xec298493, 0x0ada, 0x4ea1, 0xa4, 0xfe, 0xcb, 0xbd, 0x36, 0xce, 0x93, 0x31}
...
DEFINE_GUID!{MFSampleExtension_3DVideo_SampleFormat,
    0x08671772, 0xe36f, 0x4cff, 0x97, 0xb3, 0xd7, 0x2e, 0x20, 0x98, 0x7a, 0x48}
...
DEFINE_GUID!{MF_MEDIATYPE_MULTIPLEXED_MANAGER,
    0x13c78fb5, 0xf275, 0x4ea0, 0xbb, 0x5f, 0x02, 0x49, 0x83, 0x2b, 0x0d, 0x6e}
...
ENUM!{enum MFDepthMeasurement {
    ...
    DistanceToOpticalCenter,
}}
DEFINE_GUID!{MF_MT_DEPTH_MEASUREMENT,
    0xfd5ac489, 0x0917, 0x4bb6, 0x9d, 0x54, 0x31, 0x22, 0xbf, 0x70, 0x14, 0x4b}
...
DEFINE_GUID!{MF_MT_VIDEO_NO_FRAME_ORDERING,
    0x3f5b106f, 0x6bc2, 0x4ee3, 0xb7, 0xed, 0x89, 0x02, 0xc1, 0x8f, 0x53, 0x51}
...
DEFINE_GUID!{MFSampleExtension_ForwardedDecodeUnits,
    0x424c754c, 0x97c8, 0x48d6, 0x87, 0x77, 0xfc, 0x41, 0xf7, 0xb6, 0x08, 0x79}
DEFINE_GUID!{MFSampleExtension_TargetGlobalLuminance,
    0x3f60ef36, 0x31ef, 0x4daf, 0x83, 0x60, 0x94, 0x03, 0x97, 0xe4, 0x1e, 0xf3}
ENUM!{enum MF_CUSTOM_DECODE_UNIT_TYPE {
    MF_DECODE_UNIT_NAL,
    MF_DECODE_UNIT_SEI,
}}
DEFINE_GUID!{MFSampleExtension_ForwardedDecodeUnitType,
    0x089e57c7, 0x47d3, 0x4a26, 0xbf, 0x9c, 0x4b, 0x64, 0xfa, 0xfb, 0x5d, 0x1e}
...
STRUCT!{struct MFFOLDDOWN_MATRIX {
    cbSize: UINT32,
    cSrcChannels: UINT32,
    cDstChannels: UINT32,
...
DEFINE_GUID!{MF_MT_AUDIO_FLAC_MAX_BLOCK_SIZE,
    0x8b81adae, 0x4b5a, 0x4d40, 0x80, 0x22, 0xf3, 0x8d, 0x09, 0xca, 0x3c, 0x5c}
...
DEFINE_GUID!{MF_MT_SPATIAL_AUDIO_OBJECT_METADATA_LENGTH,
    0x094ba8be, 0xd723, 0x489f, 0x92, 0xfa, 0x76, 0x67, 0x77, 0xb3, 0x47, 0x26}
DEFINE_GUID!{MF_MT_SPATIAL_AUDIO_MAX_METADATA_ITEMS,
    0x11aa80b4, 0xe0da, 0x47c6, 0x80, 0x60, 0x96, 0xc1, 0x25, 0x9a, 0xe5, 0x0d}
DEFINE_GUID!{MF_MT_SPATIAL_AUDIO_MIN_METADATA_ITEM_OFFSET_SPACING,
    0x83e96ec9, 0x1184, 0x417e, 0x82, 0x54, 0x9f, 0x26, 0x91, 0x58, 0xfc, 0x06}
...
DEFINE_GUID!{MF_MT_DECODER_MAX_DPB_COUNT,
    0x67be144c, 0x88b7, 0x4ca9, 0x96, 0x28, 0xc8, 0x08, 0xd5, 0x26, 0x22, 0x17}
...
DEFINE_GUID!{MF_MT_MPEG2_TIMECODE,
    0x5229ba10, 0xe29d, 0x4f80, 0xa5, 0x9c, 0xdf, 0x4f, 0x18, 0x02, 0x07, 0xd2}
DEFINE_GUID!{MF_MT_MPEG2_CONTENT_PACKET,
    0x825d55e4, 0x4f12, 0x4197, 0x9e, 0xb3, 0x59, 0xb6, 0xe4, 0x71, 0x0f, 0x06}
...
DEFINE_GUID!{MF_MT_H264_SUPPORTED_SLICE_MODES,
    0xc8be1937, 0x4d64, 0x4549, 0x83, 0x43, 0xa8, 0x08, 0x6c, 0x0b, 0xfd, 0xa5}
...
DEFINE_GUID!{MF_MT_H264_SIMULCAST_SUPPORT,
    0x9ea2d63d, 0x53f0, 0x4a34, 0xb9, 0x4e, 0x9d, 0xe4, 0x9a, 0x07, 0x8c, 0xb3}
...
DEFINE_GUID!{MF_MT_ARBITRARY_HEADER,
    0x9e6bd6f5, 0x0109, 0x4f95, 0x84, 0xac, 0x93, 0x09, 0x15, 0x3a, 0x19, 0xfc}
DEFINE_GUID!{MF_MT_ARBITRARY_FORMAT,
    0x5a75b249, 0x0d7d, 0x49a1, 0xa1, 0xc3, 0xe0, 0xd8, 0x7f, 0x0c, 0xad, 0xe5}
...
DEFINE_GUID!{MF_VIDEO_MAX_MB_PER_SEC,
    0xe3f2e203, 0xd445, 0x4b8c, 0x92, 0x11, 0xae, 0x39, 0x0d, 0x3b, 0xa0, 0x17}
...
DEFINE_GUID!{MFStreamExtension_CameraExtrinsics,
    0x686196d0, 0x13e2, 0x41d9, 0x96, 0x38, 0xef, 0x03, 0x2c, 0x27, 0x2a, 0x52}
...
DEFINE_GUID!{MFStreamExtension_PinholeCameraIntrinsics,
    0xdbac0455, 0x0ec8, 0x4aef, 0x9c, 0x32, 0x7a, 0x3e, 0xe3, 0x45, 0x6f, 0x53}
...
DEFINE_GUID!{MFMediaType_Perception,
    0x597ff6f9, 0x6ea2, 0x4670, 0x85, 0xb4, 0xea, 0x84, 0x07, 0x3f, 0xe9, 0x40}
...
#[repr(C)]
pub struct VIDEOINFOHEADER { _private: [u8;0] }
#[repr(C)]
pub struct VIDEOINFOHEADER2 { _private: [u8;0] }
#[repr(C)]
pub struct MPEG1VIDEOINFO { _private: [u8;0] }
#[repr(C)]
pub struct MPEG2VIDEOINFO { _private: [u8;0] }
#[repr(C)]
pub struct AM_MEDIA_TYPE { _private: [u8;0] }
extern "system" {
...
extern "system" {
    ...
    pub fn MFUnwrapMediaType(
        pWrap: *mut IMFMediaType,
        ppOrig: *mut *mut IMFMediaType,
    ) -> HRESULT;
/*
    #[cfg(feature = "ksmedia")]
    pub fn MFCreateVideoMediaTypeFromVideoInfoHeader(
        pVideoInfoHeader: *const KS_VIDEOINFOHEADER,
    ...
    #[cfg(feature = "ksmedia")]
    pub fn MFCreateVideoMediaTypeFromVideoInfoHeader2(
        pVideoInfoHeader: *const KS_VIDEOINFOHEADER2,
        cbVideoInfoHeader: DWORD,
...
*/
    ...
    pub fn MFCreateCollection(
        ppIMFCollection: *mut *mut IMFCollection,
    ) -> HRESULT;
}
